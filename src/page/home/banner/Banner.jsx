    ...
    <div className="relative w-full h-screen">
      ...
      <div className="absolute top-0 left-0 w-full h-full  bg-black/50">
        <Container className="text-white pt-28">
         ...
         <Link to="/" className="mt-5 inline-block bg-button px-5 py-3 text-black rounded-sm border-[1px] border-button hover:bg-transparent hover:text-white transition-all duration-700">Order Now</Link>
        </Container>
      </div>
    </div>
  );
